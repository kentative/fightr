package com.bytes.fightr.client.widget.cpb;
...
public class CircularProgressButton extends android.support.v7.widget.AppCompatButton {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        mStrokeWidth = (int) getContext().getResources().getDimension(R.dimen.widget_cpb_stroke_width);
    ...
    private StrokeGradientDrawable createDrawable(int color) {
        GradientDrawable drawable = (GradientDrawable) getResources().getDrawable(R.drawable.widget_cpb_background).mutate();
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            int blue = getColor(R.color.widget_blue);
            int white = getColor(R.color.widget_white);
            int grey = getColor(R.color.widget_grey);

            int idleStateSelector = attr.getResourceId(R.styleable.CircularProgressButton_cpb_selectorIdle,
                    R.color.widget_cpb_idle_state_selector);
            ...
            int completeStateSelector = attr.getResourceId(R.styleable.CircularProgressButton_cpb_selectorComplete,
                    R.color.widget_cpb_complete_state_selector);
            ...
            int errorStateSelector = attr.getResourceId(R.styleable.CircularProgressButton_cpb_selectorError,
                    R.color.widget_cpb_error_state_selector);
