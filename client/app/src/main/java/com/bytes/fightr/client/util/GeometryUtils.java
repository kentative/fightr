 ...
 * Converted from: http://www.codeproject.com/KB/recipes/BezirCurves/BezierCurves.zip
 */
public class GeometryUtils {
    ...
    private double factorial(int n) {
        ...
        return FactorialLookup[n]; /* returns the value n! */
    }
    ...
    /**
     *
     * @param b - input points
     * @param cpts
     * @param p - output points
     */
